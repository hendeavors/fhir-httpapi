...
use Endeavors\Fhir\Http\Api\Three\Clinical as ThreeClinical;
...
use Endeavors\Fhir\Http\Api\Three\Facade\Clinical as ThreeClinicalFacade;
...
class BearerTokenTest extends TestCase
{
    ...
    public function containsBearer()
    {
        ...
        $clinical = new ThreeClinical($psr18Client);
