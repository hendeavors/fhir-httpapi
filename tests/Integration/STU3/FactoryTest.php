...
use Endeavors\Fhir\Http\Api\Three\Factory;
...
class FactoryTest extends TestCase
{
    ...
    public function condition()
    {
        $mock = new MockHandler([
            ...
            new Response(200, ['X-Foo' => 'Bar'], 'Create Condition 2'),
            new Response(200, ['X-Foo' => 'Bar'], 'Create Condition 3'),
        ...
        $response = Factory::createCondition("/createcondition", ['things'], "Bearer token2");

        $this->assertSame((string)$response->getBody(), 'Create Condition 2');

        $response = Factory::createCondition("/createcondition", Stream::create("things"), "Bearer token2");

        $this->assertSame((string)$response->getBody(), 'Create Condition 3');
    }
}
