...
namespace Endeavors\Fhir\Http\Api\Uri;

use Endeavors\Fhir\Http\Api\Uri\Read;
use Psr\Http\Message\UriInterface;

final class Write implements UriInterface
{
    /**
     * A uri represented as a value object
    ...
    {
        $this->uri = Read::make($uri);

        if ('' !== $this->uri->getQuery()) {
            throw new \InvalidArgumentException("A write uri must not contain a query part.");
        }
    }
    ...
    {
        return $this->uri->withUserInfo($user, $password = null);
    }
